...
\margl1440\margr1440\vieww30040\viewh16560\viewkind0
\deftab720
...
\
	...
	# Replace `app.address=localhost:9005` with `app.address=0.0.0.0:9005` in config file.\
	sed $SED_INPLACE "s/address = \\"localhost:9005\\"/address = \\"0.0.0.0:9005\\"/g" config.toml\
\
...
\
	...
	then completed "Listmonk is now up and running. Visit http://localhost:9005 in your browser."\
	else\
