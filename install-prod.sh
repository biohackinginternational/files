...
modify_config(){
	...
	# Replace `app.address=localhost:9004` with `app.address=0.0.0.0:9004` in config file.
	sed $SED_INPLACE "s/address = \"localhost:9004\"/address = \"0.0.0.0:9004\"/g" config.toml
...
show_output(){
	...
	then completed "Listmonk is now up and running. Visit http://localhost:9004 in your browser."
	else
